              ...
              <div className="relative flex justify-center px-4 md:px-0">
                ...
                >
                  <Image
                    ...
                    quality={90}
                    placeholder="blur"
                    blurDataURL="data:image/jpeg;base64,"
                  />
                </motion.div>
              </div>
            </div>
